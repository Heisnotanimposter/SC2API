...
from sc2.constants import NEXUS, PROBE, PYLON, ASSIMILATOR, GATEWAY, CYBERNETICSCORE, STARGATE, VOIDRAY, SCV, DRONE, ROBOTICSFACILITY, OBSERVER
import random
import cv2
import numpy as np
import os
...
for i in range(100):
    run_game(maps.get("Simple64"), [
        Bot(Race.Protoss, testapi1(use_model=True)),
